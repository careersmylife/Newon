...
interface IconProps {
  type: 'microphone' | 'check' | 'loading' | 'error' | 'chat' | 'send' | 'user' | 'aibot';
  className?: string;
}
...
const AiBotIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM8.5 12.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm7 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zM12 17.5c-2.33 0-4.31-1.46-5.11-3.5h10.22c-.8 2.04-2.78 3.5-5.11 3.5z"/>
    </svg>
);
...
export const Icon: React.FC<IconProps> = ({ type, className }) => {
  switch (type) {
    ...
    case 'aibot':
        return <AiBotIcon className={className} />;
    default:
      return null;
  }
};